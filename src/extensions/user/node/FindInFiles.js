...
/*global define, $, PathUtils, brackets, window */
...
define(function (require, exports, module) {
    ...
    */
    ...
    CommandManager.get(Commands.EDIT_FIND_IN_FILES)._commandFn = doFindInFiles;
    CommandManager.get(Commands.EDIT_FIND_IN_SUBTREE)._commandFn = doFindInSubtree;
});
